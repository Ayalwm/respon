...
var Ct = (r, t, e) => t in r ? St(r, t, { enumerable: true, configurable: true, writable: true, value: e }) : r[t] = e;
...
var Et = createBaseVNode("circle", {
  cx: "50",
  cy: "50",
  r: "50"
}, null, -1);
var Ot = { viewBox: "-20 -20 140 140" };
function Vt(r, t) {
  return openBlock(), createElementBlock("button", Tt, [
    (openBlock(), createElementBlock("svg", Ft, [
      Et,
      (openBlock(), createElementBlock("svg", Ot, [
        renderSlot(r.$slots, "default")
      ]))
    ]))
  ]);
}
var et = Lt(Rt, [["render", Vt]]);
var ut = ({ width: r, height: t }) => Math.ceil(Math.sqrt(r * r + t * t));
var $t = ({
  width: r,
  height: t
}) => r / t;
...
var _t = ((r) => (r.notLoaded = "notLoaded", r.loading = "loading", r.loaded = "loaded", r.error = "error", r))(_t || {});
var I = _t;
var bt = ((r) => (r.fill = "fill", r.fit = "fit", r))(bt || {});
var A = bt;
var yt = (r) => r >= 1 ? "landscape" : "portrait";
var At = class {
  constructor(t) {
    d(this, "realSize");
...
var Wt = class {
  ...
  cancel() {
    this.isCancelled = true, this.reject("Resources loading cancelled", this.rscs);
  }
};
var T = class _T {
  constructor({
    ...
    d(this, "width", ref(null));
    d(this, "height", ref(null));
...
var Nt = class {
  constructor(t, e, o) {
    ...
    d(this, "size");
    d(this, "viewSize");
    d(this, "translateZ", computed(() => {
      const t2 = this.depth / 2, { width: e2, height: o2 } = this.size.toValue(), { width: s, height: n } = this.viewSize.toValue();
      return {
        front: 0,
        back: this.depth,
        backr: this.depth,
...
var W = ((r) => (r.front = "front", r.back = "back", r.left = "left", r.right = "right", r.top = "top", r.bottom = "bottom", r))(W || {});
function jt(r, t, e) {
  return !!(t && t[r] || e && e[r]);
}
function Yt(r, t, e, o) {
...
var pt = defineComponent({
  ...
  setup(r, { expose: t }) {
    const e = r, o = ref(null), s = computed(
    ...
    }), (v, x) => (openBlock(), createElementBlock("div", {
      ref_key: "$el",
      ref: o,
      class: "flux-cube",
      style: normalizeStyle(unref(c))
    }, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(m.value, (E) => (openBlock(), createBlock(resolveDynamicComponent(E.component), mergeProps({
        ref_for: true,
        ref: (V) => y[E.name] = V,
        key: E.name
      }, E), null, 16))), 128))
...
var G = ((r) => (r.front = "front", r.back = "back", r.backr = "backr", r.backl = "backl", r.left = "left", r.right = "right", r.top = "top", r.bottom = "bottom", r))(G || {});
function xt(r, t) {
...
var X = defineComponent({
  ...
  setup(r, { expose: t }) {
    const e = r, o = ref(null), s = reactive({
      base: {
        position: "relative"
      }
    ...
    ), i = computed(() => Gt.getTilesProps(e)), p = ref([]);
    return onBeforeUpdate(() => {
      p.value = [];
    }), t({
      setCss: c,
      ...
      getRowNumber: xt,
      getColNumber: kt
    }), (y, _) => (openBlock(), createElementBlock("div", {
      ref_key: "$el",
      ref: o,
      class: "flux-grid",
      style: normalizeStyle(unref(n))
    }, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (v, x) => (openBlock(), createBlock(resolveDynamicComponent(l.value), mergeProps({
        ref_for: true,
...
var rt = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      show: u,
      hide: l
    }), (i, p) => (openBlock(), createElementBlock("div", {
      ref_key: "$el",
      ref: o,
      class: "flux-image",
      style: normalizeStyle(unref(n))
...
var He = defineComponent({
  ...
  setup(r, { expose: t }) {
    const { aspectRatio: e } = Bt, o = r, s = ref(null), { holder: n, rsc: c } = o, a = {
      base: {
        position: "relative",
    ...
    }, u = /iPad|iPhone|iPod/.test(navigator.userAgent) || navigator.userAgent === "MacIntel" && navigator.maxTouchPoints > 1, l = reactive({
      width: 0,
      height: 0,
      aspectRatio: computed(() => e(l))
    }), i = reactive({
      top: 0,
      width: 0,
      height: 0,
      aspectRatio: computed(() => e(i))
    }), p = reactive({
      top: 0,
      left: 0,
      width: 0,
    ...
    return t({
      resize: x
    }), (k, R) => (openBlock(), createElementBlock("div", {
      ref_key: "$el",
      ref: s,
      class: "flux-parallax",
      style: normalizeStyle(a.final.value)
    }, [
      o.type === "fixed" && !unref(u) ? (openBlock(), createElementBlock("div", {
        key: 0,
        style: m
      }, [
        createBaseVNode("div", {
...
var Kt = defineComponent({
  ...
  setup(r, { expose: t, emit: e }) {
    const o = r, s = ref(null), n = ref(null), c = e, a = reactive({
      base: {
        overflow: "hidden",
        perspective: "none",
        zIndex: 3
    ...
    onMounted(async () => {
      await nextTick(), n.value !== null && (l.value = n.value.totalDuration), c("ready", {
    ...
    async function i() {
      c("start", {
        ...
        options: o.options,
        duration: l.value
      }), await nextTick(), n.value === null ? console.error("Transition component not available", o.transition) : n.value.onPlay(), setTimeout(() => p(), l.value);
    }
    function p() {
      c("end", {
        transition: o.transition,
    ...
    }), t({ start: i }), (m, y) => (openBlock(), createElementBlock("div", {
      ref_key: "$el",
      ref: s,
      class: "flux-transition",
      style: normalizeStyle(u.value)
    }, [
      (openBlock(), createBlock(resolveDynamicComponent(m.transition), {
        ref_key: "$transition",
        ref: n,
        size: m.size,
        from: m.from,
...
var Dt = defineComponent({
  ...
  setup(r, { expose: t }) {
    const e = r, o = ref(null), s = reactive({
      ...
      e,
      s
    ), l = computed(() => Jt.getCirclesProps(e)), i = ref([]);
    return onBeforeUpdate(() => {
      i.value = [];
    }), t({
      setCss: c,
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(l.value, (_, v) => (openBlock(), createBlock(resolveDynamicComponent(m.rsc.transition.component), {
        ref_for: true,
...
var z = ((r) => (r.prev = "prev", r.next = "next", r))(z || {});
var Y = ((r) => (r.stopped = "stopped", r.playing = "playing", r))(Y || {});
var Zt = class {
  constructor() {
    d(this, "current", null);
    d(this, "from", null);
...
var te = class {
  constructor(t) {
    d(this, "list", shallowReactive([]));
    d(this, "loader", ref(null));
    d(this, "emit");
    this.emit = t;
  }
  getPrev(t) {
  ...
  update(t, e, o) {
    var c, a;
    ((c = this.loader.value) == null ? void 0 : c.hasFinished()) === false && ((a = this.loader.value) == null || a.cancel()), this.list.splice(0);
...
var oe = class {
  constructor(t, e, o) {
    d(this, "resource");
    d(this, "transition");
    d(this, "status", ref(Y.stopped));
    d(this, "config");
    d(this, "timers");
    d(this, "emit");
    d(this, "resources");
    d(this, "transitions");
    d(this, "$displayComponent", ref(null));
    this.config = t, this.timers = e, this.emit = o, this.resources = new te(o), this.transitions = new se(), this.resource = shallowReactive(new Zt()), this.transition = shallowReactive(new qt());
  }
  setup(t) {
  ...
  async stop(t = false) {
    const { timers: e } = this;
    this.status.value = Y.stopped, e.clear("transition"), this.transition.current !== null && t === true && await this.end(t), this.emit("stop");
  }
  isReadyToShow() {
  ...
  async show(t = z.next, e = z.next) {
    ...
    if (this.transition.current !== null) {
      n.allowToSkipTransition && (await this.end(true), this.show(t, e));
      return;
    }
    const a = s.find(
      t,
  ...
  async end(t = false) {
    ...
    if (!(o.current === null || s === null)) {
      if (c.setCurrentFinished(), await nextTick(), t === true ? this.emit("transitionCancel", this.resource, this.transition) : this.emit("transitionEnd", this.resource, this.transition), this.shouldStopPlaying(
        e.infinite,
        o.current,
        s.list.length - 1
      )) {
  ...
  shouldStopPlaying(t, e, o) {
    return t === false && e.index >= o && this.status.value === Y.playing || e.options.stop === true;
  }
  shouldPlayNext() {
...
var dt = class _dt {
  ...
  async updateSize() {
    if (this.size.reset(), await nextTick(), this.node.value === null)
      return;
...
var ie = class {
  constructor() {
    d(this, "isOver", ref(false));
  }
  setup(t, e) {
    e.clear("mouseOver"), t.autohideTime === 0 && (this.isOver.value = true);
  }
  toggle(t, e, o) {
...
var ce = createBaseVNode("div", { class: "remainder upper" }, null, -1);
var ue = createBaseVNode("div", { class: "remainder lower" }, null, -1);
var Ie = defineComponent({
  ...
  setup(r, { expose: t, emit: e }) {
    const o = r, s = e, n = ref(null), c = ref(null), a = ref(null), u = reactive({
    ...
    async function J() {
      ...
      try {
        await p.update(toRaw(o.rscs), j, y.size);
      } catch (P) {
        console.error(P);
      }
    ...
    function k() {
      i.transition.reset(), m.update(toRaw(o.transitions)), i.transition.init(m);
    }
    watch(
      o.transitions,
      async () => {
      ...
      E(), await y.updateSize(), y.addResizeListener(), i.setup(a), k(), await J(), u.autoplay === true && i.play(), s("mounted");
    }), onUnmounted(() => {
      l.clear(), y.removeResizeListener(), _.removeKeyListener(), s("unmounted");
    });
    const R = computed(() => y.size.isValid() ? y.inFullScreen() ? {
      width: "100% !important",
    ...
    return t({
      ...
      getPlayer: () => i,
      size: y.size
    }), s("created"), (j, P) => (openBlock(), createElementBlock("div", {
      ref_key: "$el",
      ref: n,
      class: "vue-flux",
      style: normalizeStyle(R.value),
      onMousemove: P[3] || (P[3] = (M) => unref(v).toggle(u, unref(l), true)),
      onMouseleave: P[4] || (P[4] = (M) => unref(v).toggle(u, unref(l), false)),
      onDblclick: P[5] || (P[5] = (M) => unref(y).toggleFullScreen()),
      onTouchstart: P[6] || (P[6] = (M) => unref(x).start(M, u)),
      onTouchend: P[7] || (P[7] = (M) => unref(x).end(M, u, unref(i), unref(y), unref(l), unref(v)))
    }, [
      /* eslint-disable vue/html-indent */
      unref(i).transition.current !== null && unref(y).size.isValid() && unref(i).resource.from !== null && unref(i).resource.to !== null ? (openBlock(), createBlock(unref(Kt), {
        key: 0,
        ref_key: "$transition",
        ref: c,
        transition: unref(i).transition.current.component,
        size: unref(y).size,
        from: unref(i).resource.from.rsc,
        to: unref(i).resource.to.rsc,
        "display-component": a.value,
        options: unref(i).transition.current.options,
        onReady: P[0] || (P[0] = (M) => {
          var ft;
          return (ft = c.value) == null ? void 0 : ft.start();
        }),
        onStart: P[1] || (P[1] = (M) => unref(i).start()),
        onEnd: P[2] || (P[2] = (M) => unref(i).end())
      }, null, 8, ["transition", "size", "from", "to", "display-component", "options"])) : createCommentVNode("", true),
      unref(i).resource.current !== null ? (openBlock(), createBlock(resolveDynamicComponent(unref(i).resource.current.rsc.display.component), mergeProps({
        key: 1,
        ref_key: "$displayComponent",
        ref: a,
        size: unref(y).size,
        rsc: unref(i).resource.current.rsc
      }, unref(i).resource.current.rsc.display.props), null, 16, ["size", "rsc"])) : createCommentVNode("", true),
      unref(y).size.isValid() ? (openBlock(), createElementBlock("div", ae, [
        renderSlot(j.$slots, "preloader", {
          loader: unref(p).loader
        }),
        renderSlot(j.$slots, "caption", { player: unref(i) }),
        ce,
        renderSlot(j.$slots, "controls", {
          mouseOver: unref(v).isOver,
          player: unref(i)
        }),
        ue,
        renderSlot(j.$slots, "index", {
          mouseOver: unref(v).isOver,
          displaySize: unref(y).size,
          player: unref(i)
        }),
        renderSlot(j.$slots, "pagination", { player: unref(i) })
      ])) : createCommentVNode("", true)
    ], 36));
  }
});
var Ge = defineComponent({
  ...
  setup(r) {
    const t = r, { resource: e, transition: o } = t.player, s = computed(() => e.current === null || e.current.rsc.caption === null ? "&nbsp;" : e.current.rsc.caption), n = computed(() => {
    ...
    return (c, a) => (openBlock(), createElementBlock("div", {
      ...
      renderSlot(c.$slots, "default", { caption: s.value }, () => [
        createTextVNode(toDisplayString(s.value), 1)
      ])
    ], 2));
  }
});
var pe = createBaseVNode("polyline", { points: "64,18 22,50 64,82" }, null, -1);
var he = defineComponent({
  __name: "Prev",
  setup(r) {
    return (t, e) => (openBlock(), createBlock(unref(et), { class: "prev top left" }, {
      default: withCtx(() => [
        pe
      ]),
      _: 1
...
var de = createBaseVNode("polygon", { points: "32,12 82,50 32,88" }, null, -1);
var fe = defineComponent({
  __name: "Play",
  setup(r) {
    return (t, e) => (openBlock(), createBlock(unref(et), { class: "play" }, {
      default: withCtx(() => [
        de
      ]),
      _: 1
...
var me = createBaseVNode("line", {
  x1: "32",
  y1: "22",
  x2: "32",
  y2: "78"
}, null, -1);
var ye = createBaseVNode("line", {
  x1: "68",
  y1: "22",
  x2: "68",
  y2: "78"
...
var ge = defineComponent({
  __name: "Stop",
  setup(r) {
    return (t, e) => (openBlock(), createBlock(unref(et), { class: "pause" }, {
      default: withCtx(() => [
        me,
        ye
      ]),
...
var ve = createBaseVNode("polyline", { points: "36,18 78,50 36,82" }, null, -1);
var we = defineComponent({
  __name: "Next",
  setup(r) {
    return (t, e) => (openBlock(), createBlock(unref(et), { class: "next top right" }, {
      default: withCtx(() => [
        ve
      ]),
      _: 1
...
var Ke = defineComponent({
  ...
  setup(r) {
    const t = r, e = computed(() => !(t.player.resource.current === null || t.mouseOver !== void 0 && unref(t.mouseOver) === false));
    return (o, s) => (openBlock(), createBlock(Transition, { name: "fade" }, {
      default: withCtx(() => [
        e.value ? (openBlock(), createElementBlock("div", ze, [
          createVNode(he, {
            onClick: s[0] || (s[0] = (n) => o.player.show(unref(z).prev))
          }),
          (o.player.status.value || o.player.status) === unref(Y).stopped ? (openBlock(), createBlock(fe, {
            key: 0,
            onClick: s[1] || (s[1] = (n) => o.player.play(unref(z).next, 1))
          })) : createCommentVNode("", true),
          (o.player.status.value || o.player.status) === unref(Y).playing ? (openBlock(), createBlock(ge, {
            key: 1,
            onClick: s[2] || (s[2] = (n) => o.player.stop())
          })) : createCommentVNode("", true),
          createVNode(we, {
            onClick: s[3] || (s[3] = (n) => o.player.show(unref(z).next))
          })
        ])) : createCommentVNode("", true)
      ]),
      _: 1
...
var $e = createBaseVNode("rect", {
  x: "17.5",
  y: "17.5",
  width: "12px",
  height: "12px"
}, null, -1);
var _e = createBaseVNode("rect", {
  x: "17.5",
  y: "43",
  width: "12px",
  height: "12px"
}, null, -1);
var be = createBaseVNode("rect", {
  x: "17.5",
  y: "68.5",
  width: "12px",
  height: "12px"
}, null, -1);
var xe = createBaseVNode("rect", {
  x: "43",
  y: "17.5",
  width: "12px",
  height: "12px"
}, null, -1);
var ke = createBaseVNode("rect", {
  x: "43",
  y: "43",
  width: "12px",
  height: "12px"
}, null, -1);
var De = createBaseVNode("rect", {
  x: "43",
  y: "68.5",
  width: "12px",
  height: "12px"
}, null, -1);
var Se = createBaseVNode("rect", {
  x: "68.5",
  y: "17.5",
  width: "12px",
  height: "12px"
}, null, -1);
var Ce = createBaseVNode("rect", {
  x: "68.5",
  y: "43",
  width: "12px",
  height: "12px"
}, null, -1);
var Pe = createBaseVNode("rect", {
  x: "68.5",
  y: "68.5",
  width: "12px",
  height: "12px"
...
var Le = defineComponent({
  ...
  setup(r) {
    const t = r, e = computed(
      () => [true, void 0].includes(unref(t.mouseOver))
    );
    return (o, s) => (openBlock(), createBlock(Transition, { name: "fade" }, {
      default: withCtx(() => [
        e.value ? (openBlock(), createBlock(unref(et), {
          key: 0,
...
var Re = defineComponent({
  ...
  setup(r) {
    return (t, e) => (openBlock(), createElementBlock("li", null, [
      (openBlock(), createBlock(resolveDynamicComponent(t.rsc.transition.component), {
        rsc: t.rsc,
        size: t.size.value,
        title: t.rsc.caption
...
var Ee = defineComponent({
  ...
  setup(r, { expose: t }) {
    const e = r, o = ref(null), s = ref(false), n = computed(() => {
      const l = [];
      return s.value && l.push("visible"), l;
    });
    async function c() {
      o.value !== null && (e.player.stop(), s.value = true, await nextTick(), o.value.clientHeight, o.value.style.marginTop = "0");
    }
    function a(l) {
      var i;
      o.value !== null && ((i = e.player.resource.current) == null ? void 0 : i.index) !== l && (e.mouseOver !== void 0 && (o.value.clientHeight, o.value.style.marginTop = "100%"), setTimeout(() => {
        s.value = false, l !== null && e.player.show(l);
      }, Fe));
    }
    const u = Te(e.displaySize, e.player);
    return t({ show: c }), (l, i) => (openBlock(), createElementBlock("nav", {
      class: normalizeClass(n.value),
      ...
      createBaseVNode("ul", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(l.player.resources.list, (p, m) => (openBlock(), createBlock(Re, {
          key: m,
          rsc: p.resource,
          size: unref(u).size,
          class: normalizeClass(unref(u).getClass(m)),
          onClick: (y) => a(m)
...
var Ue = defineComponent({
  ...
  setup(r) {
    const t = r, e = ref(null), o = computed(
      () => t.player.resources.list.length > 0
    );
    return (s, n) => o.value ? (openBlock(), createElementBlock("div", Oe, [
      s.mouseOver ? (openBlock(), createBlock(Le, {
        key: 0,
      ...
      }, null, 8, ["mouse-over"])) : createCommentVNode("", true),
      createVNode(Ee, {
...
var Je = defineComponent({
  ...
  setup(r) {
    ...
    } = t, n = computed(() => e.list.length > 0), c = (u) => u.resource.caption, a = (u, l) => {
      var m;
      const i = [l];
      let p = ((m = o.current) == null ? void 0 : m.index) === u;
      return s.current !== null && (p = false), p === true && i.push("active"), i;
    };
    return (u, l) => n.value ? (openBlock(), createElementBlock("nav", Ve, [
      createBaseVNode("ul", null, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(u.player.resources.list, (i, p) => (openBlock(), createElementBlock("li", { key: p }, [
          renderSlot(u.$slots, "default", {
            ...
            createBaseVNode("span", {
              title: c(i),
              class: normalizeClass(a(p, "pagination-item")),
...
var Me = { class: "preloader" };
var Ae = {
  key: 0,
  class: "spinner"
};
var We = { class: "pct" };
var Ne = createBaseVNode("div", { class: "border" }, null, -1);
    ...
    return (t, e) => {
      ...
      return openBlock(), createElementBlock("div", Me, [
        renderSlot(t.$slots, "default", {
          ...
          var c, a;
          return [
            (c = t.loader.value) != null && c.preLoading.length ? (openBlock(), createElementBlock("div", Ae, [
              createBaseVNode("div", We, toDisplayString((a = t.loader.value) == null ? void 0 : a.progress) + "%", 1),
              Ne
            ])) : createCommentVNode("", true)
          ];
        })
...
var qe = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    }), (a, u) => (openBlock(), createBlock(resolveDynamicComponent(a.from.transition.component), {
      ref_key: "$from",
      ref: o,
      rsc: a.from,
      size: a.size,
...
var Qe = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: s.totalDuration
    }), (i, p) => (openBlock(), createBlock(resolveDynamicComponent(i.from.transition.component), {
      ref_key: "$from",
      ref: o,
      rsc: i.from,
      size: i.size,
...
var ts = defineComponent({
  ...
  setup(r, { expose: t }) {
    const e = r, o = ref(null), s = ref(null), n = reactive({
      totalDuration: 1400,
      easing: "ease-in-out"
    });
    L(n, e.options);
    ...
    return {
    ...
    }), (i, p) => (openBlock(), createBlock(unref(ht), {
      ref_key: "$wrapper",
      ref: o,
      size: i.size,
      css: c
      ...
      default: withCtx(() => [
        (openBlock(), createBlock(resolveDynamicComponent(i.from.transition.component), {
          ref_key: "$from",
          ref: s,
          rsc: i.from,
          size: i.size,
...
var es = defineComponent({
  ...
  setup(r, { expose: t }) {
    const e = r, o = ref(null), s = ref(null), n = ref(null), c = reactive({
      totalDuration: 1400,
      easing: "ease-in-out"
    });
    L(c, e.options);
    ...
    }), (_, v) => (openBlock(), createBlock(unref(ht), mergeProps({
      ref_key: "$wrapper",
      ref: o
    }, u), {
      default: withCtx(() => [
        (openBlock(), createBlock(resolveDynamicComponent(unref(l).transition.component), {
          ref_key: "$left",
          ref: s,
          rsc: unref(l),
          size: _.size
        }, null, 8, ["rsc", "size"])),
        (openBlock(), createBlock(resolveDynamicComponent(unref(i).transition.component), {
          ref_key: "$right",
          ref: n,
          rsc: unref(i),
          size: _.size
...
var ss = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: n
    }), (u, l) => (openBlock(), createBlock(unref(X), {
      ref_key: "$grid",
      ref: o,
      rows: s.rows,
      cols: s.cols,
...
var ns = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: c
    }), (l, i) => (openBlock(), createBlock(unref(X), {
      ref_key: "$grid",
      ref: o,
      rows: s.rows,
      cols: s.cols,
...
var rs = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: c
    }), (v, x) => (openBlock(), createElementBlock("div", null, [
      createVNode(unref(X), mergeProps({
        ...
        size: v.size,
        "tile-css": unref(l)
      }, unref(u)), null, 16, ["rows", "cols", "size", "tile-css"]),
      a.rsc !== null ? (openBlock(), createBlock(resolveDynamicComponent(a.rsc.transition.component), mergeProps({
        key: 0,
        ref_key: "$background",
        ref: s,
        size: v.size
      }, a), null, 16, ["size"])) : createCommentVNode("", true)
    ]));
  }
});
var ls = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: n
    }), (l, i) => (openBlock(), createBlock(unref(Dt), {
      ref_key: "$vortex",
      ref: o,
      size: l.size,
      circles: s.circles,
...
var cs = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: n.totalDuration
    }), (p, m) => (openBlock(), createBlock(unref(ht), {
      ref_key: "$wrapper",
      ref: o,
      size: unref(u),
      css: l
      ...
      default: withCtx(() => [
        (openBlock(), createBlock(resolveDynamicComponent(p.from.transition.component), {
          ref_key: "$from",
          ref: s,
          size: p.size,
          rsc: p.from,
...
var us = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: s.totalDuration
    }), (l, i) => (openBlock(), createBlock(unref(pt), {
      ref_key: "$cube",
      ref: o,
      rscs: n,
      size: l.size,
...
var ps = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: n.totalDuration
    }), (x, E) => (openBlock(), createElementBlock("div", { style: a }, [
      (openBlock(), createBlock(resolveDynamicComponent(x.from.transition.component), {
        ref_key: "$from",
        ref: o,
        rsc: x.from,
        size: x.size,
...
var ds = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: u
    }), (p, m) => (openBlock(), createBlock(unref(X), {
      ref_key: "$grid",
      ref: o,
      rows: s.rows,
      cols: s.cols,
...
var ms = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: u
    }), (y, _) => (openBlock(), createBlock(unref(X), {
      ref_key: "$grid",
      ref: o,
      rows: s.rows,
      cols: s.cols,
...
var gs = defineComponent({
  ...
  setup(r, { expose: t }) {
    ...
    return t({
      ...
      totalDuration: c
    }), (i, p) => (openBlock(), createBlock(unref(X), {
      ref_key: "$grid",
      ref: o,
      rows: s.rows,
      cols: s.cols,
